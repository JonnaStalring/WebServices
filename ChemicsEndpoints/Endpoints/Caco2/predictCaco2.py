...
def Caco2(ID, smiles, project, series, CHEMICSMODELDIR):
    ...
    if project and series:
        modelPath = os.path.join(CHEMICSMODELDIR, "Caco2/local/"+project+"/"+series+"/predict.py")
    elif project and not series:
        modelPath = os.path.join(CHEMICSMODELDIR, "Caco2/local/"+project+"/predict.py")
    else:
        modelPath = os.path.join(CHEMICSMODELDIR, "Caco2/global/predict.py")
...
if __name__ == "__main__":
    ...
    potency, confidence = Caco2("123", "CCO", "RSV_FUSION_INHIBITOR", "2", CHEMICSMODELDIR)
